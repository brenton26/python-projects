...
def load_gui(self):
    ...
    self.btn_add.grid(row=8,column=1,padx=(15,0),pady=(45,10),sticky=W)
    
    self.btn_add=tk.Button(self.master,width=12,height=2,text='Add',command=lambda: \
                           phonebook_func.onDelete(self))
    self.btn_add.grid(row=8,column=2,padx=(15,0),pady=(45,10),sticky=W)
    
    self.btn_add=tk.Button(self.master,width=12,height=2,text='Add',command=lambda: \
                           phonebook_func.ask_quit(self))
    self.btn_add.grid(row=8,column=4,padx=(15,0),pady=(45,10),sticky=E)
